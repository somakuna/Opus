<div>
    <form wire:submit.prevent="create">
        <div class="modern-form">
            <h3 class="form-header"><i class="bi bi-plus-circle"></i> New circular</h3>
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" wire:model="client" class="form-control @error('client') is-invalid @enderror" placeholder=" ">
                        <label>Client</label>
                    </div>
                    @error('client')<div class="text-danger text-sm mt-1">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <div class="form-floating">
                    ...
                    @error('type')<div class="text-danger text-sm mt-1">{{ $message }}</div>@enderror
                </div>
                <div class="col-12">
                    <div class="form-floating">
                        <textarea wire:model="description" class="form-control @error('description') is-invalid @enderror" placeholder=" " style="height: 120px"></textarea>
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <div class="form-floating">
                            <input type="number" wire:model="frequency_value" class="form-control @error('frequency_value') is-invalid @enderror" placeholder=" " min="1">
                            <label>Every</label>
                        </div>
                        <select wire:model="frequency_unit" class="form-select" style="max-width: 120px;">
                    ...
                    @error('frequency_value')<div class="text-danger text-sm mt-1">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="number" wire:model="price" class="form-control @error('price') is-invalid @enderror" placeholder=" " step="0.01">
                        <label>Price</label>
                    </div>
