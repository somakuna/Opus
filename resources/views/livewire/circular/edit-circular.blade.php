    ...
    <form wire:submit.prevent="update">
        <div class="modern-form">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="date" wire:model="circular.start_date" class="form-control @error('circular.start_date') is-invalid @enderror" placeholder=" ">
                        <label>Start date</label>
                    </div>
                    @error('circular.start_date')<div class="text-danger text-sm mt-1">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="date" wire:model="circular.end_date" class="form-control @error('circular.end_date') is-invalid @enderror" placeholder=" ">
                        <label>End date</label>
                    </div>
                    @error('circular.end_date')<div class="text-danger text-sm mt-1">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
